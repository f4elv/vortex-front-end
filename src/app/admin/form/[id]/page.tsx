  ...
  return (
    <div className="min-h-screen p-10 bg-black text-white relative">
      ...
      <div className="relative bg-black/40 p-8 border border-purple-700 rounded-2xl backdrop-blur-lg shadow-[0_0_20px_rgba(147,51,234,0.4)]">
        ...
        <p><strong>Tipo de Projeto:</strong> {form.projectType}</p>
        <p><strong>Prazo:</strong> {form.deadline}</p>
        <p><strong>Orçamento:</strong> {form.budget}</p>
        <p className="mt-4"><strong>Descrição:</strong> {form.projectDescription}</p>
        ...
        <div className="mt-6">
          ...
          <button
            onClick={update}
            className="mt-4 px-6 py-3 bg-purple-600 rounded-xl hover:bg-purple-700 transition-all shadow-lg"
          >
            Salvar
          </button>
        </div>
