...
export default function About() {
  const { ref, isVisible } = useInView(0.5); // dispara quando 30% da seção aparece

  return (
    <section
      id="About"
      ref={ref}
      className="relative w-full min-h-screen px-32 flex flex-col items-center justify-center overflow-hidden"
    >
      <Blur />
